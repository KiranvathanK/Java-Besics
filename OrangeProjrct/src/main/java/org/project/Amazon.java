...
//		
		...
		Thread.sleep(2000);
		JavascriptExecutor jv = (JavascriptExecutor) site;
		jv.executeScript("window.scrollTo(0, document.body.scrollHeight)", "");
		Thread.sleep(3000);
		jv.executeScript("window.scrollTo(0, -document.body.scrollHeight)", "");	
		Thread.sleep(2000);
	
//		site.findElement(By.id("nav-global-location-data-modal-action")).click();//set location
...
//		Thread.sleep(3000);
		...
		Thread.sleep(2000);
		site.findElement(By.id("ap_email")).sendKeys("Please_Sign_In");
		
		site.findElement(By.xpath("//a[@id=\"createAccountSubmit\"]")).click();
		Thread.sleep(2000);
		site.findElement(By.xpath("//input[@id=\"ap_customer_name\"]")).sendKeys("RganerRay");
		Thread.sleep(2000);
		WebElement mobile = site.findElement(By.xpath("//span[@class=\"a-button-text a-declarative\"]"));
		mobile.click();
		Thread.sleep(2000);
		...
		site.findElement(By.xpath("//input[@id=\"ap_phone_number\"]")).sendKeys("9876543210");
		Thread.sleep(2000);
		site.findElement(By.xpath("//input[@id=\"ap_email\"]")).sendKeys("RagnerRay@outlook.com");
		Thread.sleep(2000);
		site.findElement(By.xpath("//input[@id=\"ap_password\"]")).sendKeys("pass@1234");
		Thread.sleep(2000);
		site.findElement(By.xpath("//a[@class=\"a-link-emphasis\"]")).click();
		Thread.sleep(2000);
